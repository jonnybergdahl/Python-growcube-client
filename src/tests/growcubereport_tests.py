...
class GrowCubeReportTestCase(unittest.TestCase):
    ...
    def test_device_version_report(self):
        ...
        self.assertEqual("12663500", report.device_id)
    ...
    def test_pump_open_report(self):
        ...
        self.assertEqual(0, report.pump)
